...
## With what I gathered from this I'm a bit closer to manifesting some other ideas that I have. 
...
#we then apply a size for our window, this is what worked best for me
root.geometry('232x294')
# and then we added some color for fun 
root.config(bg='red')

#This is creating our input widget(or text box)
entered = Entry(root, width = 35, borderwidth = 5)
...
def button_equal():
    #create a new value with our current number
...
button_2 = Button(root, text = '2', padx = 31, pady = 10, command = lambda : button_click(2))
...
button_5 = Button(root, text = '5', padx = 31, pady = 10, command = lambda : button_click(5))
...
button_negative = Button(root, text = '-/+', padx = 24, pady = 10, command = convert_negative)
button_0 = Button(root, text = '0', padx = 31, pady = 10, command = lambda : button_click(0))
button_dec = Button(root, text = '.', padx = 32, pady = 10, command = lambda : button_click('.'))
...
button_multi = Button(root, text = '*' , padx = 31, pady = 10, command = button_multi)
...
button_clear = Button(root, text = 'Clear', padx = 19, pady = 10, command = button_clear)
